package com.bassamalim.hidaya.services;
...
import com.bassamalim.hidaya.activities.RadioClient;
...
public class RadioService extends MediaBrowserServiceCompat implements
    ...
    private static final String ACTION_PLAY_PAUSE =
            "com.bassamalim.hidaya.services.radioservice.playpause";
    private static final String ACTION_NEXT = "com.bassamalim.hidaya.services.radioservice.next";
    private static final String ACTION_PREV = "com.bassamalim.hidaya.services.radioservice.prev";
